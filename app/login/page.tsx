    ...
    <div className="min-h-screen w-full flex items-stretch">
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-[#f6f7f9]">
        <div className="w-full max-w-[400px] fade-up">
          ...
          <form onSubmit={(e: React.FormEvent<HTMLFormElement>) => submit(e, "email")} className="space-y-3.5">
            <div>
              <label className="block text-[13px] font-semibold text-slate-600 mb-1.5">Work email</label>
              <Input icon="Mail" type="email" placeholder="you@company.com" value={email} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEmail(e.target.value)} required />
            </div>
            <div>
              ...
              <Input icon="Lock" type="password" placeholder="••••••••••" value={pwd} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPwd(e.target.value)} required />
            </div>
